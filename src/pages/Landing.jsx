...
import { ShieldCheck, LockKeyhole, Coins, ArrowRight, UserCheck, Moon, Sun } from 'lucide-react';
      ...
      <footer className="py-12 border-t border-zinc-200/50 dark:border-white/5">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg font-black text-zinc-900 dark:text-white tracking-tight">ACCORD</span>
          </div>
